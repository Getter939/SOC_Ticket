...
| Signal | Reading |
|---|---|
| Test suite | **817 tests, all passing**; **85.8% branch coverage** |
...
| 3 | Automated testing | 817 tests green; CI + 85% coverage floor | ✅ 95% |
...
- [x] **Set up CI.** GitHub Actions runs Django checks, migration consistency,
  Ruff correctness rules, all 817 tests, and coverage with an 85% floor.
