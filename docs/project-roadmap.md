...
| Signal | Reading |
|---|---|
| Test suite | **829 tests, all passing**; **85.9% branch coverage** |
...
| 3 | Automated testing | 829 tests green; CI + 85% coverage floor | ✅ 95% |
...
- [x] **Set up CI.** GitHub Actions runs Django checks, migration consistency,
  Ruff correctness rules, all 829 tests, and coverage with an 85% floor.
