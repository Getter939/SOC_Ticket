...
| Signal | Reading |
|---|---|
| Test suite | **832 tests, all passing**; **85.9% branch coverage** |
...
| 3 | Automated testing | 832 tests green; CI + 85% coverage floor | ✅ 95% |
...
- [x] **Set up CI.** GitHub Actions runs Django checks, migration consistency,
  Ruff correctness rules, all 832 tests, and coverage with an 85% floor.
