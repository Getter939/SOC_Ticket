...
| Signal | Reading |
|---|---|
| Test suite | **809 tests, all passing**; **85.7% branch coverage** |
...
| 3 | Automated testing | 809 tests green; CI + 85% coverage floor | ✅ 95% |
...
- [x] **Set up CI.** GitHub Actions runs Django checks, migration consistency,
  Ruff correctness rules, all 809 tests, and coverage with an 85% floor.
