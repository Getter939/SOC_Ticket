...
cover.push(new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 40 },
  children: [r("เวอร์ชันระบบ v1.4.0", { color: INK, size: 28 }), r("   ·   ", { color: HAIR, size: 28 }),
             r("ปรับปรุงล่าสุด 10 กันยายน 2026", { color: INK, size: 28 })] }));
cover.push(new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 40 },
  children: [r("คู่มือฉบับที่ 1.1 (ตัวอย่าง)", { color: MUTED, size: 28 })] }));
...
push(step("s53", [r("กรอกรายละเอียด: ความรุนแรง วันเวลาที่ตรวจพบ ระบบ/บริการ IP รายละเอียดเหตุการณ์ ฯลฯ — ช่อง "),
...
function numberedRefs() {
  const refs = ["s3", "s51", "s52", "s53", "s54", "s55", "s56", "s56b"];
