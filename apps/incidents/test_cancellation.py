...
class CancellationTests(MFATestCase):
    ...
    def test_thai_ui_manager_queue_and_history(self):
        ...
        manager_detail = self.client.get(detail)
        self.assertContains(manager_detail, 'อนุมัติยกเลิกรายการ')
        self.assertContains(manager_detail, 'พิจารณาคำขอยกเลิกรายการ')
        self.assertContains(manager_detail, 'class="action-disclosure cancellation-disclosure" open')
