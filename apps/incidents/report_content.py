...
SECTION1_ROWS = [
    ...
    ('kv', '1.4 วันที่ เวลา ที่แจ้งเหตุผู้ที่ได้รับผลกระทบ', 'affected_notified_at'),
    ('kv', '1.5 ชื่อ incident/event', 'incident_name'),
    ('checks', '1.6 ประเภท: event หรือ incident', [
...
# It deliberately stops after general information and folds the description
# into row 1.13 instead of printing the Incident-only sections 2-8.
EVENT_SECTION1_ROWS = [
